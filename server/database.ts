...
async function seedDatabase() {
    ...
    `);
      ...
      (1, 'BioTech Solutions', 1, 'L-Alanine', 100, '$2,500.00', 'Pending', '2025-10-26'),
      (2, 'NutraLab Inc.', 3, 'Glycine', 500, '$4,200.00', 'Shipped', '2025-10-25'),
      (1, 'BioTech Solutions', 2, 'L-Arginine', 200, '$3,800.00', 'Delivered', '2025-10-24'),
      (3, 'PharmaGreen', 5, 'L-Proline', 50, '$1,100.00', 'Processing', '2025-10-24');
    `);
